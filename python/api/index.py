...
def load_data():
    if not os.path.exists(DATA_PATH):
        ...
        try:
            ...
            print(f"Warning: Could not initialize data.json: {e}")
...
def save_data(data):
    try:
        ...
        print(f"Warning: Could not write data to read-only filesystem: {e}")
...
def login():
    ...
    save_data(data)
    return jsonify({ 'ok': True, 'profileName': username, 'redirect': '/smart_student_dashboard.html' })
